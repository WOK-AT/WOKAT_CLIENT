  ...
  return (
    <>
      ...
      <button
        ...
        className="mb-6 mt-[10px] flex h-[52px] w-full flex-row items-center justify-center rounded-[100px] bg-BLUE_500 text-system4_bold font-system4_bold text-WHTIE"
      >
        예약하러 가기
      </button>
    </>
